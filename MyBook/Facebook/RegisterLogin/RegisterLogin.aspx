<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RegisterLogin.aspx.cs" Inherits="MyBook.Register" %>
...
<body>
    ...
    <div class="image--container image--disabled" tabindex="-1">
        <br />
        <p class="image--text">Let The World Know How Sexy You Are!</p>
        <div class="image image--common">
            <i class="fas fa-question-circle question--mark"></i>
            <img src="" alt="" class="imageHolder image--common"/>
        </div>
        <p class="img--url">Image URL <input id="imageInput" type="text" name="imageInput" runat="server" tabindex="-1"/></p>
